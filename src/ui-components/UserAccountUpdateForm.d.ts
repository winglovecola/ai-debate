...
import { UserAccount } from "../API.ts";
...
export declare type UserAccountUpdateFormInputValues = {
    ip?: string;
    userData?: string;
    userGroups?: string;
...
export declare type UserAccountUpdateFormValidationValues = {
...
export declare type UserAccountUpdateFormOverridesProps = {
    UserAccountUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type UserAccountUpdateFormProps = React.PropsWithChildren<{
    overrides?: UserAccountUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    userAccount?: UserAccount;
    onSubmit?: (fields: UserAccountUpdateFormInputValues) => UserAccountUpdateFormInputValues;
    onSuccess?: (fields: UserAccountUpdateFormInputValues) => void;
    onError?: (fields: UserAccountUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: UserAccountUpdateFormInputValues) => UserAccountUpdateFormInputValues;
    onValidate?: UserAccountUpdateFormValidationValues;
} & React.CSSProperties>;
export default function UserAccountUpdateForm(props: UserAccountUpdateFormProps): React.ReactElement;
