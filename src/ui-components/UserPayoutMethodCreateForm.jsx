...
import { createUserPayoutMethod } from "../graphql/mutations";
const client = generateClient();
export default function UserPayoutMethodCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPaypal(initialValues.paypal);
    setInterac(initialValues.interac);
    setPaperCheck(initialValues.paperCheck);
    setCashApp(initialValues.cashApp);
    setVenmo(initialValues.venmo);
    setVerificationIdType(initialValues.verificationIdType);
    setVerificationId(initialValues.verificationId);
    setCountry(initialValues.country);
    setDefaultPayoutMethod(initialValues.defaultPayoutMethod);
    setCustomContactEmail(initialValues.customContactEmail);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserPayoutMethod.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserPayoutMethodCreateForm")}
      {...rest}
    >
      <TextField
        label="Paypal"
