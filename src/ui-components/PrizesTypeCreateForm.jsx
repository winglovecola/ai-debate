...
import { createPrizesType } from "../graphql/mutations";
const client = generateClient();
export default function PrizesTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPrizesType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PrizesTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
