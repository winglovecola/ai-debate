...
import { EventSessionFree } from "../API.ts";
...
export declare type EventSessionFreeUpdateFormInputValues = {
    eventType?: string;
    rewardType?: string;
...
export declare type EventSessionFreeUpdateFormValidationValues = {
...
export declare type EventSessionFreeUpdateFormOverridesProps = {
    EventSessionFreeUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type EventSessionFreeUpdateFormProps = React.PropsWithChildren<{
    overrides?: EventSessionFreeUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    eventSessionFree?: EventSessionFree;
    onSubmit?: (fields: EventSessionFreeUpdateFormInputValues) => EventSessionFreeUpdateFormInputValues;
    onSuccess?: (fields: EventSessionFreeUpdateFormInputValues) => void;
    onError?: (fields: EventSessionFreeUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EventSessionFreeUpdateFormInputValues) => EventSessionFreeUpdateFormInputValues;
    onValidate?: EventSessionFreeUpdateFormValidationValues;
} & React.CSSProperties>;
export default function EventSessionFreeUpdateForm(props: EventSessionFreeUpdateFormProps): React.ReactElement;
