...
import { createUserPointsRecord } from "../graphql/mutations";
const client = generateClient();
export default function UserPointsRecordCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTrLoyalityPoints(initialValues.trLoyalityPoints);
    setTrScore(initialValues.trScore);
    setTrRanking(initialValues.trRanking);
    setTrRewardPoints(initialValues.trRewardPoints);
    setTrTotalQuestions(initialValues.trTotalQuestions);
    setTrCorrectAnswers(initialValues.trCorrectAnswers);
    setErrors({});
  };
  const validations = {
    trLoyaltyBonus: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserPointsRecord.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserPointsRecordCreateForm")}
      {...rest}
    >
      <TextField
