...
export default function EventsCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setScorePoolData(initialValues.scorePoolData);
    setScoreAccess(initialValues.scoreAccess);
    setScoreAllowView(initialValues.scoreAllowView);
    setWinnerCorrectAnswerCount(initialValues.winnerCorrectAnswerCount);
    setWinnerQualifyTimeSec(initialValues.winnerQualifyTimeSec);
    setEventAllowedUsers(initialValues.eventAllowedUsers);
    setCurrentEventAllowedUsersValue("");
    setInitiateTime(initialValues.initiateTime);
    setBroadcastTime(initialValues.broadcastTime);
    setEventEndingTime(initialValues.eventEndingTime);
