...
import { createKismetNumberSetting } from "../graphql/mutations";
const client = generateClient();
export default function KismetNumberSettingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setOidCount(initialValues.oidCount);
    setErrors({});
  };
  const validations = {
    oidCount: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createKismetNumberSetting.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "KismetNumberSettingCreateForm")}
      {...rest}
    >
      <TextField
        label="Oid count"
