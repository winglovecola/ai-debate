...
import { createDebateTopic } from "../graphql/mutations";
const client = generateClient();
export default function DebateTopicCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDebateTopic.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DebateTopicCreateForm")}
      {...rest}
    >
      <TextField
        label="Topic"
