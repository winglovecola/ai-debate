...
export declare type EventSessionFreeCreateFormInputValues = {
    eventType?: string;
    rewardType?: string;
...
export declare type EventSessionFreeCreateFormValidationValues = {
...
export declare type EventSessionFreeCreateFormOverridesProps = {
    EventSessionFreeCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type EventSessionFreeCreateFormProps = React.PropsWithChildren<{
    overrides?: EventSessionFreeCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: EventSessionFreeCreateFormInputValues) => EventSessionFreeCreateFormInputValues;
    onSuccess?: (fields: EventSessionFreeCreateFormInputValues) => void;
    onError?: (fields: EventSessionFreeCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EventSessionFreeCreateFormInputValues) => EventSessionFreeCreateFormInputValues;
    onValidate?: EventSessionFreeCreateFormValidationValues;
} & React.CSSProperties>;
export default function EventSessionFreeCreateForm(props: EventSessionFreeCreateFormProps): React.ReactElement;
