...
import { createUserAccess } from "../graphql/mutations";
const client = generateClient();
export default function UserAccessCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setAdminAccess(initialValues.adminAccess);
    setErrors({});
  };
  const validations = {
    adminAccess: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserAccess.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserAccessCreateForm")}
      {...rest}
    >
      <TextField
        label="Admin access"
