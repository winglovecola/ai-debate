...
import { EventSession } from "../API.ts";
...
export declare type EventSessionUpdateFormInputValues = {
    eventType?: string;
    rewardType?: string;
...
export declare type EventSessionUpdateFormValidationValues = {
...
export declare type EventSessionUpdateFormOverridesProps = {
    EventSessionUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type EventSessionUpdateFormProps = React.PropsWithChildren<{
    overrides?: EventSessionUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    eventSession?: EventSession;
    onSubmit?: (fields: EventSessionUpdateFormInputValues) => EventSessionUpdateFormInputValues;
    onSuccess?: (fields: EventSessionUpdateFormInputValues) => void;
    onError?: (fields: EventSessionUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: EventSessionUpdateFormInputValues) => EventSessionUpdateFormInputValues;
    onValidate?: EventSessionUpdateFormValidationValues;
} & React.CSSProperties>;
export default function EventSessionUpdateForm(props: EventSessionUpdateFormProps): React.ReactElement;
