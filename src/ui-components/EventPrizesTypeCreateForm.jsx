...
import { createEventPrizesType } from "../graphql/mutations";
const client = generateClient();
export default function EventPrizesTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPrizeType(initialValues.prizeType);
    setPrizeValue(initialValues.prizeValue);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createEventPrizesType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "EventPrizesTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
