...
import { createUserReward } from "../graphql/mutations";
const client = generateClient();
export default function UserRewardCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUserReward.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserRewardCreateForm")}
      {...rest}
    >
      <TextField
