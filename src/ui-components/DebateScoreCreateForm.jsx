...
import { createDebateScore } from "../graphql/mutations";
const client = generateClient();
export default function DebateScoreCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setWinningTeam(initialValues.winningTeam);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDebateScore.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DebateScoreCreateForm")}
      {...rest}
    >
      <TextField
        label="Winning team"
